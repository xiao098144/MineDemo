...
//		settings.setSupportZoom(true);
        ...
        wv.setWebViewClient(new WebViewClient(){
			...
			@Override
             public void onPageStarted(WebView pView, String pUrl, Bitmap pBit) {
                 Log.e(" èµ„è®¯è¯¦æƒ… ","onPageStarted: " + pUrl);
                     ...
                     public void onReceiveValue(Map map) {
                         for(Object key : map.keySet()) {
                             ...
                             if(Build.VERSION.SDK_INT >= 11) {
                                 ...
                                 Log.e(" èµ„è®¯è¯¦æƒ… ", String.format("Origin: %s Quota: %s Usage: %s",
                                         origin.getOrigin(), origin.getQuota(), origin.getUsage()));

                             } else {
                                 Log.e(" èµ„è®¯è¯¦æƒ… ", "Key: " + key + " Value: " + map.get(key));
                             }
                         }
                     }
                 });
	...
	private class AppCacheWebChromeClient extends WebChromeClient {
        ...
        public void onReachedMaxAppCacheSize(long spaceNeeded, long totalUsedQuota, WebStorage.QuotaUpdater quotaUpdater) {
            Log.e("APPCACHE", "onReachedMaxAppCacheSize reached, increasing space: " + spaceNeeded);
...
public class MainActivity extends ActionBarActivity {
	...
	private WebView wv;
	String url = "http://www.moko.cc/post/1059870.html";
...
//		settings.setSupportZoom(true);
        ...
        wv.setWebViewClient(new WebViewClient(){
			...
			@Override
             public void onPageStarted(WebView pView, String pUrl, Bitmap pBit) {
                 Log.e(" ×ÊÑ¶ÏêÇé ","onPageStarted: " + pUrl);
					...
					@Override
                     public void onReceiveValue(Map map) {
                         for(Object key : map.keySet()) {
                             ...
                             if(Build.VERSION.SDK_INT >= 11) {
                                 WebStorage.Origin origin = (WebStorage.Origin) map.get(key);
                                 Log.e(" ×ÊÑ¶ÏêÇé ", String.format("Origin: %s Quota: %s Usage: %s",
                                         origin.getOrigin(), origin.getQuota(), origin.getUsage()));

                             } else {
                                 Log.e(" ×ÊÑ¶ÏêÇé ", "Key: " + key + " Value: " + map.get(key));
                             }
                         }
                     }
                 });
...
>>>>>>> 9b5041263e699dc5b219e02b4bc64dfe9075a416
